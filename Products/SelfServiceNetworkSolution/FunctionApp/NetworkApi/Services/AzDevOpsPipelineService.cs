...
namespace Cbsp.Foundation.Network.Api.Services
{
    ...
    public partial class AzDevOpsPipelineService : IAzDevOpsPipelineService
    {
        ...
        /// <summary>This method returns a specific Build Definition within the Organization's Project
        /// <example>For example:
        /// <code>
        ///    AzDevOpsService azsrv = new AzDevOpsService();
        ///    azsrv.GetBuildDefinition("cbsp-azure","Azure","100");
        /// </code>
        /// results in model return model object <c>BuildDefinitionResponse</c>.
        /// </example>
        /// </summary>
